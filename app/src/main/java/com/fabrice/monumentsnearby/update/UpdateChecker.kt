...
/**
 * Vérification des mises à jour sur GitHub Releases (repo ClawFabriceH92/monuments-nearby).
...
object UpdateChecker {
    ...
    private const val RELEASES_URL =
        "https://api.github.com/repos/ClawFabriceH92/monuments-nearby/releases?per_page=5"
    ...
    fun latestWithApk(): UpdateInfo? {
        ...
        conn.setRequestProperty("User-Agent", "Monuments Nearby-UpdateChecker")
        return try {
